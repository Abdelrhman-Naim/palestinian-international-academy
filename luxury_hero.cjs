...
hero = hero.replace('className="bg-primary text-gray-900 dark:text-white font-label-caps px-6 py-3 rounded-lg font-bold hover:text-amber-300 cursor-pointer transition-transform active:scale-95 flex items-center gap-2"',
...
hero = hero.replace('className="border border-gray-600 bg-transparent text-gray-900 dark:text-white font-label-caps px-6 py-3 rounded-lg font-bold hover:bg-white dark:bg-black hover:text-gray-900 dark:text-white transition-colors text-center inline-block"',
...
// Stats design
hero = hero.replace('<div className="flex gap-12 pt-8 border-t border-gray-700 mt-8 w-fit">',
